...
var QuokkaCoreFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_quokkacore_free(ptr >>> 0, 1));

class QuokkaCore {
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
    QuokkaCoreFinalization.unregister(this);
    return ptr;
  }
  free() {
    const ptr = this.__destroy_into_raw();
    wasm.__wbg_quokkacore_free(ptr, 0);
  }
  constructor() {
    const ret = wasm.quokkacore_new();
    this.__wbg_ptr = ret >>> 0;
    QuokkaCoreFinalization.register(this, this.__wbg_ptr, this);
    return this;
  }
  render_markdown(input) {
    ...
    try {
      ...
      const ret = wasm.quokkacore_render_markdown(this.__wbg_ptr, ptr0, len0);
      var ptr2 = ret[0];
      var len2 = ret[1];
      if (ret[3]) {
        ptr2 = 0;
  ...
  clear_cache() {
    wasm.quokkacore_clear_cache(this.__wbg_ptr);
  }
  set_debug(debug) {
    wasm.quokkacore_set_debug(this.__wbg_ptr, debug);
  }
}
...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === "undefined") {
    module_or_path = new URL("quokka_bg.wasm", import.meta.url);
  }
...
class Quokka {
  ...
  async initialize() {
    ...
    try {
      await quokka_default();
      console.log("WASM initialized successfully");
      this.core = new QuokkaCore;
      console.log("QuokkaCore instance created");
  ...
  async renderMarkdown(content) {
    ...
    if (!this.core) {
      throw new Error("Quokka not properly initialized");
    }
  ...
  async renderLatexBlocks(html) {
    html = html.replace(/\$\$([\s\S]*?)\$\$/g, (_, tex) => this.renderLatex(tex, true));
    html = html.replace(/\$((?!\$).*?)\$/g, (_, tex) => this.renderLatex(tex, false));
    return html;
  }
  clearCache() {
...
var quokka_default2 = Quokka;
export {
  quokka_default2 as default,
  Quokka
};
